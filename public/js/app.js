...
// === Drag and Drop Image Upload Logic ===
    ...
    // ============================================
    // NEW: Multiple Gallery Drag & Drop Logic
    // ============================================
    ...
    // (Note: We must manually assign dropped files to the input)
    $galleryZone.on('drop', function(e) {
        const dt = e.originalEvent.dataTransfer;
        const files = dt.files;

        // Assign files to the input so PHP can see them on submit
